...
- **Teoría (09:00–11:00):** Instalación y verificación de Python, VS Code y Jupyter. Creación de entorno virtual. Cuenta y repositorio inicial en GitHub.
- **Práctica (11:30–13:30):** Repaso de variables, tipos de datos, estructuras de control (`if`/`for`/`while`) y funciones, con ejercicios cortos.
- **Repaso (15:00–16:30):** Documentación del objetivo del plan de 30 días en este README.
...
- **Teoría (09:00–11:00):** Creación de arrays, indexing, slicing y broadcasting.
- **Práctica (11:30–13:30):** Operaciones vectorizadas, funciones estadísticas (`mean`, `std`, `sum`) y comparación de rendimiento vs. listas de Python.
- **Repaso (15:00–16:30):** 10 ejercicios cortos de manipulación de arrays (Kaggle/Exercism).
